...
const MobileNav = () => {
    return (
        <>
           <nav className=" flex w-full items-center justify-between lg:hidden">
                <div className="w-28  ">
                    <img
                        src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.png" alt="logo" className="w-full h-full " />
                </div>
                <div className="flex items-center gap-3">
                    <button className="bg-zomato-400 text-white py-2 px-3 rounded-full"> Use App </button>
                    <span className="border p-2 border-gray-300 text-zomato-400 rounded-full"> <FaUserAlt/>
                    </span>
                </div>
           </nav>
        </>
...
const LargeNav = () => {
    return (
        <>
            <div className="lg:inline container px-16 mx-auto">
                <div className="hidden gap-4 w-full items-center justify-around lg:flex ">
                    ...
                    <div className="w-full bg-white shadow-md px-3 py-3 flex items-center gap-3 border border-gray-200 rounded ">
                        <div className="flex items-center gap-2 border-r-2 border-gray-300 pr-2">
                            ...
                            <input type="text" placeholder="Bhusawal" className="w-full h-full focus:outline-none"/>
                            <IoMdArrowDropdown />
                        </div>
...
const Navbar = () => {
    return (
        <div className="p-4 flex bg-white shadow-md lg:shadow-none w-full items-center">
            <MobileNav />
            <LargeNav />
        </div>
    );
