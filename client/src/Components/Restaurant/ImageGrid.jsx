             ...
             <div className=" w-full h-60  md:hidden">
                ...
                <div className="hidden w-full h-96 md:flex gap-1">
                    ...
                    <div className="w-1/4 h-full flex flex-col gap-1 overflow-hidden">
                        <img src={props.images[1]} alt="restaurant image" className="w-full h-2/4 object-cover rounded-lg transform transition duration-700  hover:scale-110" />

                        <img src={props.images[2]} alt="restaurant image" className="w-full h-2/4 object-cover rounded-lg transform transition duration-700  hover:scale-110" />
                    </div>
